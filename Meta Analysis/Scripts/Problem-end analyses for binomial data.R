...
# Load data
initialdatog <- read.csv(here("Meta Analysis", "Problem-end data", "Initial decision problem.csv"))
#initialdatog %>% View
...
# Load data
postinitialreviewdatog <- read.csv(here("Meta Analysis", "Problem-end data", "Post initial review problem.csv"))
...
# Load data
finaldatog <- read.csv(here("Meta Analysis", "Problem-end data", "Final decision problem.csv"))
#finaldatog %>% View
...
# Load data
overalldatog <- read.csv(here("Meta Analysis", "Problem-end data", "Overall decision problem.csv"))
#overalldatog %>% View
...
# Load data
alldatog <- read.csv(here("Meta Analysis", "Problem-end data", "Journal nationalism problem binomial.csv"))
#alldatog %>% View
...
# Load data
overalldatog <- read.csv(here("Meta Analysis", "Problem-end data", "Overall decision problem COUNTRY.csv"))
#overalldatog %>% View

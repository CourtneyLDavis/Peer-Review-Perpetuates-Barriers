...
setwd("D:/Olivia/Desktop/olivia.m.smith/Desktop/EEB CRG/Obj. 1 and 3/Analyzable data/Moving towards analyzable files/Solution end/Double blind/Checked")
#change this to yours

####################Initial decision##################

# Load data
initialdatog <- read.csv('Initial decision solution double blind.csv')
...
# Load data
postinitialreviewdatog <- read.csv('Post initial review decision solution double blind.csv')
...
# Load data
finaldatog <- read.csv('Final decision solution double blind.csv')
...
#################Overall decision###################
# Load data
overalldatog <- read.csv('Overall decision solution double blind.csv')
...
### Load the overall decision data 
overalldatog <- read.csv("Overall decision solution double blind COUNTRY.csv")
head(overalldatog)
...
reviewscoredat <- read.csv("Review scores solution double blind.csv", fileEncoding="UTF-8-BOM")
head(reviewscoredat)
...
nreviewersdat <- read.csv("Number reviewers solution double blind.csv", fileEncoding="UTF-8-BOM")
head(nreviewersdat)
...
#####################################################
### Load the number revisions data 
nrevisionsdat <- read.csv("Number revisions solution double blind.csv", fileEncoding="UTF-8-BOM")
head(nrevisionsdat)

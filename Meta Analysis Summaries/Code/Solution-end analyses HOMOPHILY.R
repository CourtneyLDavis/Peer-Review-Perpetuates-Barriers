...
setwd("D:/Olivia/Desktop/olivia.m.smith/Desktop/EEB CRG/Obj. 1 and 3/Analyzable data/Moving towards analyzable files/Solution end/Assessor diversity/Checked/Analyses")
...
# Load data
initialdatEDog <- read.csv('Initial decision solution editor diversity.csv', fileEncoding="UTF-8-BOM")
...
# Load data
postinitialreviewdatEDog <- read.csv('Post initial review solution editor diversity.csv',  fileEncoding="UTF-8-BOM")
...
# Load data
finaldatEDog <- read.csv('Final decision solution editor diversity.csv', fileEncoding="UTF-8-BOM")
...
overalldatEDog <- read.csv('Overall decision solution editor diversity.csv', fileEncoding="UTF-8-BOM")
...
# Load data
postinitialreviewdatREVog <- read.csv('Post initial review solution reviewer diversity.csv', fileEncoding="UTF-8-BOM")
...
# Load data
finaldatREVog <- read.csv('Final decision solution reviewer diversity.csv', fileEncoding="UTF-8-BOM")
...
# Load data
overalldatREVog <- read.csv('Overall decision solution reviewer diversity.csv', fileEncoding="UTF-8-BOM")
...
nreviewersdat <- read.csv("Number reviewers solution editor diversity.csv", fileEncoding="UTF-8-BOM")
head(nreviewersdat)
...
reviewscoredat <- read.csv("Review scores solution diversity reviewer COUNTRY.csv", fileEncoding="UTF-8-BOM")
head(reviewscoredat)
...
nrevisionsdat <- read.csv("Number revisions solution reviewer diversity.csv", fileEncoding="UTF-8-BOM")
head(nrevisionsdat)
